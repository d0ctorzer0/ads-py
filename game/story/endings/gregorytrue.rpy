label END_gregtrue:
    ...
    python:
        ...
        achievement.sync()
    g2e "This is incredible."
    g1e "You know, I think I read about this in one of Aperture's records."
    g3e "If this is the ocean, why can I see a shoreline on the other side?"
    mc "It's not the ocean. We're on Lake Michigan."
    g3e "W-Well. It's nothing special, but..."
    g2e "Rie."
    g3e "Haha, okay, you got me, Gore."
    g3e "This is beautiful."
    g1e "I'm so happy I'm here right now."
    g1e "This is the best day ever."
    g2e "I agree. This is excellent."
    g3e "I..."
    n "Rie turns to you."
    g3e "I-I'm sorry if I've seemed negative lately. I really am..."
    g3e "I really am grateful."
    g3e "I..."
    g3e "I love you."
    g1e "Awww, Rie."
    g2e "She finally admits it."
    g1e "Same goes for me. I love you, Doctor. Thanks for taking us out here."
    g2e "This was a great idea."
    menu:
        extend ""
        "I love you guys, too.":
            mc "I-I know things have been weird... getting adjusted to this."
            mc "I appreciate you all being patient with me..."
            mc "...while I figured out my feelings."
            g2e "Of course. It only makes sense."
            g2e "The relationship the four of us have..."
            g1e "It's a little different, that's for sure."
        "Thank you guys.":
            pass

    g3e "I wouldn't trade you all, or this moment, for the world."
    g1e "Who knew you were such a sap under that hard shell?"
    g2e "I had a feeling."
    n "You laugh."
    n "It's hard not to."
    n "You look out across the waves."
    n "There's still some things to figure out..."
    n "Some hurdles to overcome..."
    n "But you have a feeling things will be alright."
