label END_gregtrue:
    ...
    python:
        ...
        achievement.sync()
    g2e "{color=#fff}This is incredible."
    g1e "{color=#fff}You know, I think I read about this in one of Aperture's records."
    g3e "{color=#fff}If this is the ocean, why can I see a shoreline on the other side?"
    mc "{color=#fff}It's not the ocean. We're on Lake Michigan."
    g3e "{color=#fff}W-Well. It's nothing special, but..."
    g2e "{color=#fff}Rie."
    g3e "{color=#fff}Haha, okay, you got me, Gore."
    g3e "{color=#fff}This is beautiful."
    g1e "{color=#fff}I'm so happy I'm here right now."
    g1e "{color=#fff}This is the best day ever."
    g2e "{color=#fff}I agree. This is excellent."
    g3e "{color=#fff}I..."
    n "{color=#fff}Rie turns to you."
    g3e "{color=#fff}I-I'm sorry if I've seemed negative lately. I really am..."
    g3e "{color=#fff}I really am grateful."
    g3e "{color=#fff}I..."
    g3e "{color=#fff}I love you."
    g1e "{color=#fff}Awww, Rie."
    g2e "{color=#fff}She finally admits it."
    g1e "{color=#fff}Same goes for me. I love you, Doctor. Thanks for taking us out here."
    g2e "{color=#fff}This was a great idea."
    menu:
        extend ""
        "I love you guys, too.":
            ...
            g2e "{color=#fff}Of course. It only makes sense."
            g2e "{color=#fff}The relationship the four of us have..."
            g1e "{color=#fff}It's a little different, that's for sure."
        "Thank you guys.":
            pass

    g3e "{color=#fff}I wouldn't trade you all, or this moment, for the world."
    g1e "{color=#fff}Who knew you were such a sap under that hard shell?"
    g2e "{color=#fff}I had a feeling."
