...
label saveaspen:
    ...
    window auto
    scene aspenroom hell with fade
    show flash
...
label saveccunknown:
    ...
    if cctv == True:
        ...
        ucg "{color=#fff}Uh - yeah. I broke into the office and stole it back from ya. Sorry, Doc."
        ucg "{color=#fff}Figured out after some snooping around that it used to be used for transporting CC around."

        c "{color=#fff}He's right. I-I had no idea it was with him this whole time, haha..."
    elif cctv == False:
        mccut "{color=#fff}What is that thing?"

        ucg "{color=#fff}It's the... uh, CCTV. Cancer Core Transportation Vehicle, or somethin' like that."
        ucg "{color=#fff}Used to be used for hauling CC around campus. Guess it got stuffed into my old closet a while back."
    ...
    if lock_unknown:
        ucg "{color=#fff}You better not, Doc. It's dangerous. The whole place could come crashing down any minute."
        mccut "{color=#fff}Neither of you have hands. I'm your only hope."

        ucg "{color=#fff}But..."
        ucg "{color=#fff}Ugh. You're right, as usual. C'mere. Be careful - if ya got hurt, I wouldn't forgive myself."
    ...
    if lock_unknown:
        ucg "{color=#fff}Wish you were handlin' {i}me{/i} like that, haha..."
