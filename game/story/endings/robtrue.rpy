label END_robtrue:
    ...
    rcg "{color=#fff}I've got some sensation."
    rcg "{color=#fff}Glad they didn't install those pain receptors in me, though..."
    rcg "{color=#fff}Some cores get that. Sounded horrible."
    rcg "{color=#fff}This broken handle and optic of mine would prolly hurt like hell if I had those things."
    rcg "{color=#fff}..."
    rcg "{color=#fff}Man, today was just perfect."
    rcg "{color=#fff}I couldn't imagine anything better than bein' out here with you right now."
    rcg "{color=#fff}I had no idea what I was missing down in Aperture..."
    rcg "{color=#fff}Screw Celine. I should've been lookin' for a human sooner, huh?"
    mc "{color=#fff}Haha. I think we got a little lucky."
    rcg "{color=#fff}Tell me about it! Who woulda thought a little core like me would have such a beautiful human for a partner..."
    rcg "{color=#fff}{i}I'm{/i} the lucky one here, Doc."
    rcg "{color=#fff}God..."
    rcg "{color=#fff}You're beautiful."
    rcg "{color=#fff}Thanks for bringin' me out here."
    rcg "{color=#fff}This was everything I coulda hoped for..."
    rcg "{color=#fff}And more."
