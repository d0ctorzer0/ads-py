...
screen secretbendy(): # here's where the new ACH_INSURANCE achievement should be granted - when this button is clicked!
    imagebutton idle "images/bendy.png" xpos 1080 ypos 520 action Play("sound", "sfx/notif.ogg"), Function(insurance_achievement), SetVariable("ach_name", "insurance"), Show("ach_popup")
